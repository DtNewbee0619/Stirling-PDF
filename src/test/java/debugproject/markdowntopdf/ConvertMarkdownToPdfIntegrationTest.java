package debugproject.markdowntopdf;
    ...
    public void convertValidMarkdownToPdf_shouldReturnPdfBytes() throws Exception {
        ...
        try {
            ...
            org.junit.jupiter.api.Assumptions.assumeTrue(
                    exit == 0, "Skipping: weasyprint not installed");
        } catch (Exception e) {
            org.junit.jupiter.api.Assumptions.assumeTrue(
                    false, "Skipping: weasyprint check failed");
            return;
        }
        ...
        MockMultipartFile mockFile =
                new MockMultipartFile(
                        "fileInput", "Markdown.md", "text/markdown", res.getInputStream());
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        header().string(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_PDF_VALUE))
        ...
        MvcResult mvcResult =
                mockMvc.perform(
                        ...
                        .andExpect(
                                header().string(
                                                "Content-Disposition",
                                                containsString("filename=\"empty.pdf\"")))
                        .andReturn();
